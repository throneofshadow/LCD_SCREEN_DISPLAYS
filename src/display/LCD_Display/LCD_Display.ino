...
void template_mode_estop(float dis1, float dis2){
  ...
  Paint_Clear(WHITE);
  Paint_DrawString_EN(0, 0, "Demo : Emergency Mode", &Font24, WHITE, BLACK);
  ...
  Paint_DrawString_EN(50, 180, "VOLTAGE", &Font16, RED, WHITE);  // Label for data 1
  Paint_DrawString_EN(200, 180, "CURRENT", &Font16, RED, WHITE); // label for data 2
  ...
  delay(100000); // 1s time for screen to refresh.
}
...
void template_mode_main(int switch_value, float Voltage){
  ...
  Paint_NewImage(LCD_WIDTH, LCD_HEIGHT, 0, WHITE);
  Paint_Clear(RED);
  Paint_DrawString_EN(0, 0, "Demo : Main Mode", &Font24, RED, BLACK);

  Paint_DrawLine(160, 0, 160, 240, WHITE, DOT_PIXEL_1X1,LINE_STYLE_SOLID);// Horizontal grid line
  Paint_DrawLine(0, 120, 320, 120, WHITE, DOT_PIXEL_1X1, LINE_STYLE_SOLID); //Vertical grid line
  Paint_DrawString_EN(0, 0, "Main Mode", &Font24, RED, BLACK);
...
void template_mode_1(int switch_value, float Voltage)
{
  ...
  Paint_NewImage(LCD_WIDTH, LCD_HEIGHT, 0, WHITE);
  Paint_Clear(RED);
  Paint_DrawString_EN(0, 0, "Demo: Mode 1", &Font24, RED, BLACK);
  Paint_DrawLine(160, 0, 160, 240, WHITE, DOT_PIXEL_1X1,LINE_STYLE_SOLID);// Horizontal grid line
  Paint_DrawLine(0, 120, 320, 120, WHITE, DOT_PIXEL_1X1, LINE_STYLE_SOLID); //Vertical grid line
...
void template_mode_2(int switch_value, float Voltage)
{
  ...
  Paint_NewImage(LCD_WIDTH, LCD_HEIGHT, 0, WHITE);
  Paint_Clear(RED);
  Paint_DrawString_EN(0, 0, "Demo: Mode 2", &Font24, RED, BLACK);
  Paint_DrawLine(160, 0, 160, 240, WHITE, DOT_PIXEL_1X1,LINE_STYLE_SOLID);// Horizontal grid line
  Paint_DrawLine(0, 120, 320, 120, WHITE, DOT_PIXEL_1X1, LINE_STYLE_SOLID); //Vertical grid line
